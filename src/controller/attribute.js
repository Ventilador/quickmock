...
const $animate = angular.injector(['ng']).get('$animate');
const $$sanitizeUri = angular.injector(['ng']).get('$$sanitizeUri');
Attributes.prototype = {
    ...
    $set: function(key, value, writeAttr, attrName) {
        ...
        if (attrName) {
            ...
            if (!attrName) {
                this.$attr[key] = attrName = toSnakeCase(key, '-');
            }
        }
...
function nodeName_(element) {
    const myElem = angular.element(element)[0];
    if (myElem) {
